...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (call
                            (fun "foo" "x" (add (var "x")
                                                (ifgreater (int 5) (var "x")
                                                           (call (var "foo") (add (var "x") (int 1))) (int 0)))) (int 1)))
                 (int 15) "call")
   ...
   (check-equal? (eval-exp (mlet*
                            (list (cons "x" (int 10)) (cons "y" (add (var "x") (int 2))))
                            (add (var "x") (var "y")))) (int 22) "mlet* test")
   ;; ifeq test
   ...
   ;;challenge
  ; (check-equal? (compute-free-vars (fun #f "x" (add (var "x") (int 7)))) (fun-challenge #f "x"  (add (var "x") (int 7)) (set (var "x"))) "free-vars")
