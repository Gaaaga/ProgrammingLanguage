...
(define tests
  (test-suite
   ...
   (check-equal? (stream-for-n-steps (stream-add-zero funny-number-stream) 6) (list (cons 0 1) (cons 0 2) (cons 0 3) (cons 0 4) (cons 0 -5) (cons 0 6)) "stream-add-zero test")
  ...
  (check-equal? ((cached-assoc (list (cons 1 2) (cons 3 4) (cons 5 6)) 3) 5) (cons 5 6) "cached-assoc test")
  ; while-less test
