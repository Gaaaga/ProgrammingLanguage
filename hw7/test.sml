...
let
	...
	val b = LineSegment(0.0,0.0,1.0,1.0)
	val LineSegment(a,b,c,d) = intersect(a,b)
in
	if real_equal(a,0.0) andalso real_equal(c,1.0)
	then (print "Intersect success!!!!!!!")
  else (print "Intersect failed!!!!!!!")
end
